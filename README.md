...
It is however inspired by markdown and colors headers that match the regular expression "# (.*)" blue and colors any "-" character the color called "beet" in the nano supported colors
